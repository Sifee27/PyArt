#!/bin/bash
# PyArt Voice Commands Launch Script for Unix/Linux/macOS

cd "$(dirname "$0")"

echo "Starting PyArt with Voice Commands..."
echo "Please ensure you have installed all requirements: pip install -r requirements.txt"
echo "Note: Voice commands require microphone access and internet connection for speech recognition."
